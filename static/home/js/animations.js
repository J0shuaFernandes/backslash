// a script written to animate objects
...
function moveForBlog()  { 
  ...
  document.getElementById('des').innerHTML = 'Read about the latest updates regarding the event <a href="blog/" id="blog_lnk"> here.</a>';
  curr = 2;
}
...
function moveForEvents() {
  ...
  document.getElementById('des').innerHTML = 'Learn more about different events taking place <a href="events/" id="events_lnk"> here.</a>';       
  curr = 3;
}